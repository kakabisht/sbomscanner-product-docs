...
To run the scans, {sboms-short-name} currently needs the following external
sources:
...
Once mirrored in your own OCI registry, you can install {sboms-short-name} to
point to them:
...
To configure a VEX Hub in {sboms-short-name}, create a `VEXHub` resource with
