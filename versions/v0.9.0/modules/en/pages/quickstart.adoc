...
Welcome to the {sboms-short-name} Quick Start!

This guide will walk you through the following steps:

* Deploying the {sboms-short-name} stack in a Kubernetes cluster
...
== Deploy {sboms-short-name}

Follow these simple steps from your local machine to get {sboms-short-name} up
and running:
...
for {sboms-short-name} to fetch images.
...
The `ScanJob` CR tells {sboms-short-name} which registry to scan.
