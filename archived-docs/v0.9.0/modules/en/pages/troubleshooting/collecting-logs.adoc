...
script found in the {sboms-short-name} repository]:
...
* Logs from the pods of all {sboms-short-name} components (controller, workers,
storage, NATS).
* Manifest of all {sboms-short-name} related resources (Registry, VEXHub,
